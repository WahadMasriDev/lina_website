      ...
      <div className="flex w-full flex-col gap-5">
        <Reveal index={0}>
          <section className="relative w-full aspect-[1864/978] overflow-hidden">
            ...
            <img
              src="/images/mcintosh-virgil-abloh.png"
              alt="McIntosh x Virgil Abloh"
            ...
            <div className="absolute inset-x-0 bottom-10 px-4 text-white sm:bottom-16 sm:px-8 md:bottom-20">
              <p className="text-xl font-normal sm:text-2xl md:text-[33.256px] md:leading-[40px]">
                THIS IS <span className="font-bold">MCINTOSH X VIRGIL ABLOH</span>
              </p>
        ...
        <Reveal index={1}>
          <ProjectVideo src="/videos/mcintosh-abloh.mp4" pressAnimation />
        </Reveal>
        ...
        <Reveal index={2}>
          <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-2">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/images/mcintosh-abloh-2.jpg"
              alt="McIntosh x Virgil Abloh detail"
              className="w-full object-cover"
            />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/images/mcintosh-abloh-3.jpg"
              alt="McIntosh x Virgil Abloh detail"
              className="w-full object-cover"
            />
          </div>
