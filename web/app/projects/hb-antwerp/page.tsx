  ...
  return (
    <div className="flex min-h-screen flex-col items-center gap-5 bg-black px-4 pt-[31px] pb-[31px] sm:px-8">
      ...
      <div className="flex w-full flex-col gap-5">
        ...
        <Reveal index={1}>
          <ProjectVideo src="/videos/hb-antwerp.mp4" pressAnimation />
        </Reveal>
        ...
        <Reveal index={2}>
          <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-2">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/images/hb-antwerp-2.jpg"
              alt="HB Antwerp detail"
              className="w-full object-cover"
            />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/images/hb-antwerp-3.jpg"
              alt="HB Antwerp detail"
              className="w-full object-cover"
            />
          </div>
