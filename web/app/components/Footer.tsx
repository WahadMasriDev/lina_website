  ...
  return (
    <footer className="flex w-full flex-col items-stretch gap-6 px-4 py-10 sm:gap-[23px] sm:px-8 lg:px-[95px]">
      <div className="flex items-center justify-between">
        <h2 className="text-[19px] font-bold leading-[23px] text-[#F5F5F5]">
          CONTACTEZ MOI
        </h2>
      </div>
      ...
      <div className="flex flex-col gap-10 sm:flex-row sm:items-start sm:justify-between">
        <div className="max-w-[737px]">
          <div className="h-[2px] w-[30px] bg-white" />
          <p className="mt-4 max-w-[400px] text-[14px] leading-[17px] text-[#A8A8AD]">
          ...
          <div className="mt-8 flex flex-col gap-6 sm:flex-row sm:items-center sm:gap-[73px]">
            <a
              ...
              className="flex items-center gap-2 text-[13px] leading-[16px] text-[#E6E6E8] hover:opacity-70"
            >
              <MailIcon />
        ...
        <div className="flex flex-col items-start gap-[13px]">
          <p className="text-[11px] leading-[14px] tracking-wide text-[#7A7A80]">
            SUIVEZ-MOI
          </p>
      ...
      <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-[12px] leading-[15px] text-[#929298]">
          © Lina Zakaria — Tous droits réservés
        </p>
        <nav className="flex flex-wrap items-center gap-x-8 gap-y-2">
          <Link
            href="/"
            className="text-[12px] uppercase leading-[15px] text-[#F5F5F7] hover:opacity-70"
          >
            Work
          </Link>
          <a
